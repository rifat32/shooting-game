...
var x = document.getElementById("score").innerHTML;
   var z = parseInt(x);
    ...
    document.getElementById("score").innerHTML = m;
       if (m >= 50 ){
           document.getElementById("congrats").innerHTML =  "congratulations! You Have unlocked Medium Level";
       }
...
function location1(){
    let g = document.getElementById("score").innerHTML;
    var h = parseInt(g);
    if (g >= 50 ){
          document.getElementById("medium").removeAttribute("data-toggle"); 
        document.getElementById("medium").removeAttribute("data-target"); 
        document.getElementById("medium").href="mediumlevel.html";
        mediumlevel/mediumlevel.html
