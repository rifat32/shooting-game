...
var x = document.getElementById("score").innerHTML;
   var z = parseInt(x);
    ...
    document.getElementById("score").innerHTML = m;
       if (m >= 25 ){
           document.getElementById("congrats").innerHTML =  "congratulations! You Have unlocked Hard Level";
       }
...
function location2(){
    ...
    var h = parseInt(g);
    if (g >= 25 ){
          document.getElementById("hard").removeAttribute("data-toggle"); 
        document.getElementById("hard").removeAttribute("data-target"); 
        document.getElementById("hard").href="hardlevel.html";
